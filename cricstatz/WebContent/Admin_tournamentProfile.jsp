...
<body>
	...
	<div class="banner1" style="margin-bottom: 10px">
		<div class="wthree_banner1_info">
			<h3><span>T</span>ournament Profile</h3>
		</div>
	</div>
		...
		<div class="container">
			<div class="col-md-6 w3ls_banner_bottom_left">
				<div class="w3ls_banner_bottom_right1">
					<h2>CM CHASHAK</h2>
					<p>Organized By : XXX<br>
                       25th January 2019 12:00 AM   TO   27th January 2019 12:00 AM</p>
					<p>Last Date for joining : 20th January 2019 12:00 AM<br>
						Tournament Owner : Darshan Manek
				   </p>
			...
			<div class="col-md-6 w3ls_banner_bottom_right">
								...
								<div>
									<img src="images/trophy.jpg" alt=" " class="img-responsive" style="height:400px;width:250px;" />
									<br>
									 <button class="btn btn-md btn-success ">Register To Tournament</button>
									  </button> 

		...
		<div class="container">
			<div class="col-md-6 w3ls_banner_bottom_left">
				<div class="w3ls_banner_bottom_right1">
					<h2>Game Review</h2>
					<p>Cricket is a bat-and-ball game played between two teams of eleven players on a field at the centre of which is
						a 20-metre (22-yard)
						pitch with a wicket at each end, each comprising two bails balanced on three stumps. The batting side scores runs
						by striking the ball bowled at the wicket with the bat,
						while the bowling and fielding side tries to prevent this and dismiss each player (so they are "out").</p>
					<p>There are various formats ranging from Twenty20, played over a few hours with each team batting for a single
						innings of 20 overs,
						to Test matches, played over five days with unlimited overs and the teams each batting for two innings of
						unlimited length.
						Traditionally cricketers play in all-white kit, but in limited overs cricket they wear club or team colours. </p>
					<ul class="some_agile_facts">
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i> One-Day Series</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i> IPL</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i> T-20</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Test</li>
					</ul>
				</div>
						...
						<ul class="slides">
							<li>
								<div class="agileits_w3layouts_banner_bottom_grid">
									<img src="images/1.jpg" alt=" " class="img-responsive" style="height:100%;width:100%;object-fit: contain" />
								</div>
							</li>
							<li>
								<div class="agileits_w3layouts_banner_bottom_grid">
									<img src="images/2.jpg" alt=" " class="img-responsive" style="height: 100%;width:100%;object-fit: contain" />
								</div>
							</li>
							<li>
								<div class="agileits_w3layouts_banner_bottom_grid">
									<img src="images/3.jpg" alt=" " class="img-responsive" style="height:100%;width:100%;object-fit: contain" />
								</div>
							</li>
						</ul>
					</div>
...
<div class="container">
 <h3 class="w3l_header w3_agileits_header">Latest <span>Reviews</span></h3>
